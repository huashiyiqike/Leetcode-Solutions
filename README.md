...
|14|[Longest Common Prefix](https://leetcode.com/problems/longest-common-prefix)|[py](./leetcode_py/Longest Common Prefix.py) [js](./leetcode_js/Longest Common Prefix.js) [java](./leetcode_java/longest-common-prefix/Solution.java)|Easy| |
...
|16|[3Sum Closest](https://leetcode.com/problems/3sum-closest)|[py](./leetcode_py/3Sum Closest.py) [js](./leetcode_js/3Sum Closest.js) [java](./leetcode_java/3sum-closest/Solution.java)|Medium| |
|17|[Letter Combinations of a Phone Number](https://leetcode.com/problems/letter-combinations-of-a-phone-number)|[py](./leetcode_py/Letter Combinations of a Phone Number.py) [js](./leetcode_js/Letter Combinations of a Phone Number.js) [java](./leetcode_java/letter-combinations-of-a-phone-number/Solution.java)|Medium| |
...
|19|[Remove Nth Node From End of List](https://leetcode.com/problems/remove-nth-node-from-end-of-list)|[py](./leetcode_py/Remove Nth Node From End of List.py) [js](./leetcode_js/Remove Nth Node From End of List.js) [java](./leetcode_java/remove-nth-node-from-end-of-list/Solution.java)|Easy| |
|20|[Valid Parentheses](https://leetcode.com/problems/valid-parentheses)|[py](./leetcode_py/Valid Parentheses.py) [js](./leetcode_js/Valid Parentheses.js) [java](./leetcode_java/valid-parentheses/Solution.java)|Easy| |
|21|[Merge Two Sorted Lists](https://leetcode.com/problems/merge-two-sorted-lists)|[py](./leetcode_py/Merge Two Sorted Lists.py) [js](./leetcode_js/Merge Two Sorted Lists.js) [java](./leetcode_java/merge-two-sorted-lists/Solution.java)|Easy| |
|22|[Generate Parentheses](https://leetcode.com/problems/generate-parentheses)|[py](./leetcode_py/Generate Parentheses.py) [js](./leetcode_js/Generate Parentheses.js) [java](./leetcode_java/generate-parentheses/Solution.java)|Medium| |
|23|[Merge k Sorted Lists](https://leetcode.com/problems/merge-k-sorted-lists)|[py](./leetcode_py/Merge k Sorted Lists.py) [js](./leetcode_js/Merge k Sorted Lists.js) [java](./leetcode_java/merge-k-sorted-lists/Solution.java)|Hard|[essence](./analysis/Merge k Sorted Lists.md)|
...
|26|[Remove Duplicates from Sorted Array](https://leetcode.com/problems/remove-duplicates-from-sorted-array)|[py](./leetcode_py/Remove Duplicates from Sorted Array.py) [js](./leetcode_js/Remove Duplicates from Sorted Array.js) [java](./leetcode_java/remove-duplicates-from-sorted-array/Solution.java)|Easy| |
|27|[Remove Element](https://leetcode.com/problems/remove-element)|[py](./leetcode_py/Remove Element.py) [js](./leetcode_js/Remove Element.js) [java](./leetcode_java/remove-element/Solution.java)|Easy| |
...
|33|[Search in Rotated Sorted Array](https://leetcode.com/problems/search-in-rotated-sorted-array)|[py](./leetcode_py/Search in Rotated Sorted Array.py) [js](./leetcode_js/Search in Rotated Sorted Array.js) [java](./leetcode_java/search-in-rotated-sorted-array/Solution.java)|Hard|[essence](./analysis/Search in Rotated Sorted Array.md)|
|34|[Search for a Range](https://leetcode.com/problems/search-for-a-range)|[py](./leetcode_py/Search for a Range.py) [js](./leetcode_js/Search for a Range.js) [java](./leetcode_java/search-for-a-range/Solution.java)|Medium| |
...
|81|[Search in Rotated Sorted Array II](https://leetcode.com/problems/search-in-rotated-sorted-array-ii)|[py](./leetcode_py/Search in Rotated Sorted Array II.py) [js](./leetcode_js/Search in Rotated Sorted Array II.js) [java](./leetcode_java/search-in-rotated-sorted-array-ii/Solution.java)|Medium|[essence](./analysis/Search in Rotated Sorted Array II.md)|
...
|153|[Find Minimum in Rotated Sorted Array](https://leetcode.com/problems/find-minimum-in-rotated-sorted-array)|[py](./leetcode_py/Find Minimum in Rotated Sorted Array.py) [java](./leetcode_java/find-minimum-in-rotated-sorted-array/Solution.java)|Medium|[essence](./analysis/Find Minimum in Rotated Sorted Array.md)|
